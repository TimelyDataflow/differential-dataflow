        ...
        let (mut data_input, mut keys_input) = worker.dataflow(|scope| {
            ...
            match mode.as_str() {
                ...
                "col" => {
                    ...
                    type Ba = differential_dataflow::trace::chunk::col::ChunkBatcher<u64, (), u64, isize>;
                    type Bu = differential_dataflow::trace::chunk::col::ChunkBuilder<u64, (), u64, isize>;
                    type Sp = differential_dataflow::trace::chunk::col::ChunkSpine<u64, (), u64, isize>;
                    type Chu = ContainerChunker<ColChunk<(u64, (), u64, isize)>>;
                    let data = arrange_core::<_, _, Chu, Ba, Bu, Sp>(
                        data.inner, Exchange::new(|u: &((u64, ()), u64, isize)| (u.0).0.hashed().into()), "Data");
                    let keys = arrange_core::<_, _, Chu, Ba, Bu, Sp>(
                        keys.inner, Exchange::new(|u: &((u64, ()), u64, isize)| (u.0).0.hashed().into()), "Keys");
