...
fn proxy_matches_mainline(updates: Vec<((u64, u64), u64, i64)>, window: usize) {
    ...
    timely::execute_directly(move |worker| {
        worker.dataflow::<u64, _, _>(|scope| {
            ...
            let arr = arrange_core::<Pipeline, Vec<((u64, (u64, u64)), u64, i64)>, ContainerChunker<VecChunk<u64, (u64, u64), u64, i64>>, _, VChunkSpine<u64, (u64, u64), u64, i64>>(hashed.inner, Pipeline, "Arrange", VChunkBatcher::new);
...
fn reduce_string_values_matches_mainline() {
    ...
    timely::execute_directly(move |worker| {
        worker.dataflow::<u64, _, _>(|scope| {
            ...
            let arr = arrange_core::<Pipeline, Vec<((u64, (u64, String)), u64, i64)>, ContainerChunker<VecChunk<u64, (u64, String), u64, i64>>, _, VChunkSpine<u64, (u64, String), u64, i64>>(hashed.inner, Pipeline, "Arrange", VChunkBatcher::new);
    ...
    timely::execute_directly(move |worker| {
        worker.dataflow::<u64, _, _>(|scope| {
            ...
            let result = input.iterate(|_scope, inner| {
                ...
                let arr = arrange_core::<Pipeline, Vec<((u64, (u64, u64)), Product<u64, u64>, i64)>, ContainerChunker<VecChunk<u64, (u64, u64), Product<u64, u64>, i64>>, _, VChunkSpine<u64, (u64, u64), Product<u64, u64>, i64>>(hashed.inner, Pipeline, "ArrIter", VChunkBatcher::new);
    ...
    timely::execute_directly(move |worker| {
        worker.dataflow::<u64, _, _>(|scope| {
            ...
            let result = input.iterate(|_scope, inner| {
                ...
                let arr = arrange_core::<Pipeline, Vec<((u64, (u64, u64)), Product<u64, u64>, i64)>, ContainerChunker<VecChunk<u64, (u64, u64), Product<u64, u64>, i64>>, _, VChunkSpine<u64, (u64, u64), Product<u64, u64>, i64>>(hashed.inner, Pipeline, "ArrCollide", VChunkBatcher::new);
