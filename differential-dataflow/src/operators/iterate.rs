...
pub trait Iterate<G: Scope<Timestamp: Lattice+crate::Data>, D: Data, R: Semigroup> {
...
impl<G: Scope<Timestamp: Lattice+crate::Data>, D: Ord+Data+Debug, R: Abelian+'static> Iterate<G, D, R> for VecCollection<G, D, R> {
    fn iterate<F>(self, logic: F) -> VecCollection<G, D, R>
    where
        for<'a> F: FnOnce(Iterative<'a, G, u64>, VecCollection<Iterative<'a, G, u64>, D, R>)->VecCollection<Iterative<'a, G, u64>, D, R>,
    {
...
impl<G: Scope<Timestamp: Lattice+crate::Data>, D: Ord+Data+Debug, R: Semigroup+'static> Iterate<G, D, R> for G {
