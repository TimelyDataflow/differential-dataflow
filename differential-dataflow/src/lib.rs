...
pub trait Data : columnar::Columnar<Container: trace::implementations::OrdContainer> + Ord + Debug + Clone + 'static { }
impl<T: columnar::Columnar<Container: trace::implementations::OrdContainer> + Ord + Debug + Clone + 'static> Data for T { }

/// Data types exchangeable in differential dataflow.
pub trait ExchangeData : timely::ExchangeData + Data { }
impl<T: timely::ExchangeData + Data> ExchangeData for T { }
