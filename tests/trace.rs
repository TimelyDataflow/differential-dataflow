...
use differential_dataflow::trace::implementations::rc::RcBatch;
use differential_dataflow::trace::{Trace, TraceReader, Batch, Batcher};
use differential_dataflow::trace::cursor::Cursor;
use differential_dataflow::trace::implementations::spine_fueled::Spine;

pub type OrdValSpine<K, V, T, R> = Spine<RcBatch<OrdValBatch<K, V, T, R>>>;

type IntegerTrace = OrdValSpine<u64, u64, usize, i64>;

fn get_trace() -> Spine<RcBatch<OrdValBatch<u64, u64, usize, i64>>> {
