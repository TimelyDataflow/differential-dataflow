...
use differential_dataflow::trace::implementations::{ValSpine, KeySpine, ValBatcher, KeyBatcher, ValBuilder, KeyBuilder, VecChunker};
...
fn unoptimized() {
    ...
    timely::execute_from_args(std::env::args(), move |worker| {
        ...
        let (mut a, mut d) = worker.dataflow::<Time,_,_>(|scope| {
            ...
            let dereference = dereference.arrange::<VecChunker<_>,ValBatcher<_,_,_,_>, ValBuilder<_,_,_,_>, ValSpine<_,_,_,_>>();
            ...
            scope
                .iterative::<Iter,_,_>(|scope| {
                    ...
                    let value_flow_arranged = value_flow.arrange::<VecChunker<_>,ValBatcher<_,_,_,_>, ValBuilder<_,_,_,_>, ValSpine<_,_,_,_>>();
                    let memory_alias_arranged = memory_alias.arrange::<VecChunker<_>,ValBatcher<_,_,_,_>, ValBuilder<_,_,_,_>, ValSpine<_,_,_,_>>();
                    ...
                    let value_flow_next =
                    value_flow_next
                        .arrange::<VecChunker<_>,KeyBatcher<_,_,_>, KeyBuilder<_,_,_>, KeySpine<_,_,_>>()
