...
use differential_dataflow::trace::implementations::{ValSpine, KeySpine, KeyBatcher, KeyBuilder, ValBatcher, ValBuilder, VecChunker};
...
fn main() {
    ...
    timely::execute_from_args(std::env::args().skip(1), move |worker| {
        ...
        let mut input = worker.dataflow::<(),_,_>(|scope| {
            ...
            let graph = graph.arrange::<VecChunker<_>, ValBatcher<_,_,_,_>, ValBuilder<_,_,_,_>, ValSpine<_,_,_,_>>();
